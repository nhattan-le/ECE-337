...
module rcu ( clk, n_rst, start_bit_detected, packet_done, framing_error, 
  ...
  wire   n14, n15, n3, n4, n5, n6, n7, n8, n9, n10, n11;
  wire   [1:0] state;

  DFFSR \state_reg[0]  ( .D(n15), .CLK(clk), .R(n_rst), .S(1'b1), .Q(state[0])
         );
  DFFSR \state_reg[1]  ( .D(n14), .CLK(clk), .R(n_rst), .S(1'b1), .Q(state[1])
         );
  NOR2X1 U5 ( .A(n3), .B(n4), .Y(sbc_clear) );
  NAND2X1 U6 ( .A(n5), .B(n6), .Y(n4) );
  INVX1 U7 ( .A(n7), .Y(sbc_enable) );
  XOR2X1 U8 ( .A(n5), .B(n8), .Y(n15) );
  OAI21X1 U9 ( .A(n9), .B(n8), .C(n7), .Y(n14) );
  OAI21X1 U10 ( .A(packet_done), .B(n9), .C(n10), .Y(n8) );
  NAND3X1 U11 ( .A(n5), .B(n6), .C(n3), .Y(n10) );
  INVX1 U12 ( .A(start_bit_detected), .Y(n3) );
  AND2X1 U13 ( .A(n11), .B(state[0]), .Y(load_buffer) );
  NOR2X1 U14 ( .A(framing_error), .B(n6), .Y(n11) );
  NAND2X1 U15 ( .A(n7), .B(n9), .Y(enable_timer) );
  NAND2X1 U16 ( .A(state[0]), .B(n6), .Y(n9) );
  INVX1 U17 ( .A(state[1]), .Y(n6) );
  NAND2X1 U18 ( .A(state[1]), .B(n5), .Y(n7) );
  INVX1 U19 ( .A(state[0]), .Y(n5) );
endmodule
